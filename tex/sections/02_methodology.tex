...
\subsubsection{2.3 Brain-Tuning: Semantic Alignment}
DIVER의 fMRI 데이터를 사용하여 Titans의 상위 레벨 표상을 의미론적으로 정렬합니다 \cite{benara2025braintuning}.

\subsubsection{2.4 Biological Validation: Gastric Interoception (Murine Data)}
...
\subsection{2.5 실험 및 검증 계획 (Validation Plan)}
\begin{itemize}
