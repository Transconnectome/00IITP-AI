\section{내수용 감각장 및 알로스태틱 뉴로트윈 (Allostatic Neuro-Twin)}

\subsection{개요: 예측적 생존 본능 (Predictive Allostasis)}
...
\subsection{시스템 구조: Neuro-Twin Loop}
사용자의 신체 및 환경 데이터를 실시간으로 미러링하는 \textbf{"Digital Neuro-Twin"}을 구축함.

\subsubsection{Ubiquitous & Visceral Sensing (입력)}
\begin{itemize}
...
\subsubsection{Energy Landscape Inference (처리)}
...
\subsubsection{Predictive Nudge (개입)}
