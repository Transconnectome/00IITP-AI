...
목표는 **Brain & AI 연구를 기반으로, 장기적으로 Neuromorphic Computing까지 확장 가능한 연구 로드맵**을 설계·제안·실행하는 것입니다.
...
4. **Neuromorphic까지의 단계적 로드맵**: (알고리즘/표현) → (에너지/지연 최적화) → (spiking/이벤트기반) → (HW co-design)
